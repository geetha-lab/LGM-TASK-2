...
function getData(a)
{
    ...
    fetch(url).then((response)=>{
       ...
       var value=data;       
           ...
           document.getElementById('p6img').src = img1;
           var img2=(value['data'][1]['avatar']);
           document.getElementById('p5img').src = img2;
           ...
           document.getElementById('p2img').src = img3;
           var img3=(value['data'][5]['avatar']);
           document.getElementById('p1img').src = img3;
           ///// name of the user
     ...
     /////email addresses of each user
      var mail1=(value['data'][5]['email']);
           document.getElementById('mail1').innerHTML=mail1;
           var mail2=(value['data'][4]['email']);
           ...
           var mail3=(value['data'][1]['email']);
           document.getElementById('mail5').innerHTML=mail3;
           var mail3=(value['data'][0]['email']);
